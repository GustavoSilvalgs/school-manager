...
public class StudentController {
    ...
    @Operation(summary = "Updates a Student",
            description = "Updates a Student by passing in a JSON, XML or YML representation of the student!",
            tags = {"Student"},
            responses = {
    ...
    @Operation(summary = "Deletes a Student",
            description = "Deletes a Student by passing in a JSON, XML or YML representation of the student!",
            tags = {"Student"},
            responses = {
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
